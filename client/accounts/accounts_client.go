...
/*
HaltAggregation halts subscription aggregation

??
*/
func (a *Client) HaltAggregation(params *HaltAggregationParams) (*HaltAggregationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewHaltAggregationParams()
	}
	...
	return result.(*HaltAggregationOK), nil

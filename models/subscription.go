...
/* polymorph Subscription accountID false */

/* polymorph Subscription aggregateAllSubscriptionsOnAccount false */

/* polymorph Subscription changedBy false */

/* polymorph Subscription contractStart false */

/* polymorph Subscription created false */

/* polymorph Subscription creditEnabled false */

/* polymorph Subscription crmID false */

/* polymorph Subscription currentPeriodEnd false */

/* polymorph Subscription currentPeriodEndExplicit false */

/* polymorph Subscription currentPeriodStart false */

/* polymorph Subscription currentTime false */

/* polymorph Subscription description false */

/* polymorph Subscription dunning false */

/* polymorph Subscription failedPaymentBehaviour false */

/* polymorph Subscription fixedTerms false */

/* polymorph Subscription id false */

/* polymorph Subscription initialPeriodStart false */

/* polymorph Subscription locked false */

/* polymorph Subscription managedBy false */

/* polymorph Subscription metadata false */

/* polymorph Subscription name false */

/* polymorph Subscription organizationID false */

/* polymorph Subscription parentID false */

/* polymorph Subscription paymentMethodSubscriptionLinks false */

/* polymorph Subscription paymentTerms false */

/* polymorph Subscription pricingComponentValues false */

/* polymorph Subscription productID false */

/* polymorph Subscription productRatePlanID false */

/* polymorph Subscription state false */

/* polymorph Subscription subscriptionEnd false */

/* polymorph Subscription successfulPeriods false */

/* polymorph Subscription timeOffset false */

/* polymorph Subscription totalPeriods false */

/* polymorph Subscription trialEnd false */

/* polymorph Subscription type false */

/* polymorph Subscription updated false */

/* polymorph Subscription versionEnd false */

/* polymorph Subscription versionID false */

/* polymorph Subscription versionNumber false */

/* polymorph Subscription versionStart false */
...
func (m *Subscription) validateCurrentTime(formats strfmt.Registry) error {
	...
	if err := validate.FormatOf("currentTime", "body", "date-time", m.CurrentTime.String(), formats); err != nil {
		return err
	}
...
func (m *Subscription) validateInitialPeriodStart(formats strfmt.Registry) error {
	...
	if err := validate.FormatOf("initialPeriodStart", "body", "date-time", m.InitialPeriodStart.String(), formats); err != nil {
		return err
	}
...
func (m *Subscription) validateTrialEnd(formats strfmt.Registry) error {
	...
	if err := validate.FormatOf("trialEnd", "body", "date-time", m.TrialEnd.String(), formats); err != nil {
		return err
	}
...
func (m *Subscription) validateVersionStart(formats strfmt.Registry) error {
	...
	if err := validate.FormatOf("versionStart", "body", "date-time", m.VersionStart.String(), formats); err != nil {
		return err
	}

...
func (m *StripeAuthCaptureRequest) UnmarshalJSON(raw []byte) error {
	...
	result.accountIdField = base.AccountID

	result.companyNameField = base.CompanyName

	result.defaultPaymentMethodField = base.DefaultPaymentMethod

	result.emailField = base.Email

	result.firstNameField = base.FirstName

	result.gatewayField = base.Gateway

	result.lastNameField = base.LastName

	result.mobileField = base.Mobile
	...
	result.StripeToken = data.StripeToken
...
func (m *StripeAuthCaptureRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *StripeAuthCaptureRequest) UnmarshalBinary(b []byte) error {
	var res StripeAuthCaptureRequest

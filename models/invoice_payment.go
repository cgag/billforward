...
/* polymorph InvoicePayment actualAmount false */

/* polymorph InvoicePayment changedBy false */

/* polymorph InvoicePayment created false */

/* polymorph InvoicePayment crmID false */

/* polymorph InvoicePayment currency false */

/* polymorph InvoicePayment gateway false */

/* polymorph InvoicePayment id false */

/* polymorph InvoicePayment invoiceID false */

/* polymorph InvoicePayment nominalAmount false */

/* polymorph InvoicePayment organizationID false */

/* polymorph InvoicePayment paymentID false */

/* polymorph InvoicePayment paymentReceived false */

/* polymorph InvoicePayment refundReceived false */

/* polymorph InvoicePayment refundedAmount false */

/* polymorph InvoicePayment updated false */
...
func (m *InvoicePayment) validatePaymentReceived(formats strfmt.Registry) error {
	...
	if err := validate.FormatOf("paymentReceived", "body", "date-time", m.PaymentReceived.String(), formats); err != nil {
		return err
	}
...
func (m *InvoicePayment) validateRefundReceived(formats strfmt.Registry) error {
	...
	if err := validate.FormatOf("refundReceived", "body", "date-time", m.RefundReceived.String(), formats); err != nil {
		return err
	}

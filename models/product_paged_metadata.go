...
/* polymorph ProductPagedMetadata currentOffset false */

/* polymorph ProductPagedMetadata currentPage false */

/* polymorph ProductPagedMetadata executionTime false */

/* polymorph ProductPagedMetadata nextPage false */

/* polymorph ProductPagedMetadata recordsRequested false */

/* polymorph ProductPagedMetadata recordsReturned false */

/* polymorph ProductPagedMetadata results false */
...
func (m *ProductPagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProductPagedMetadata) UnmarshalBinary(b []byte) error {
	var res ProductPagedMetadata

...
/* polymorph SubscriptionPagedMetadata currentOffset false */

/* polymorph SubscriptionPagedMetadata currentPage false */

/* polymorph SubscriptionPagedMetadata executionTime false */

/* polymorph SubscriptionPagedMetadata nextPage false */

/* polymorph SubscriptionPagedMetadata recordsRequested false */

/* polymorph SubscriptionPagedMetadata recordsReturned false */

/* polymorph SubscriptionPagedMetadata results false */
...
func (m *SubscriptionPagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SubscriptionPagedMetadata) UnmarshalBinary(b []byte) error {
	var res SubscriptionPagedMetadata

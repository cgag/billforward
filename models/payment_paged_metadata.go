...
/* polymorph PaymentPagedMetadata currentOffset false */

/* polymorph PaymentPagedMetadata currentPage false */

/* polymorph PaymentPagedMetadata executionTime false */

/* polymorph PaymentPagedMetadata nextPage false */

/* polymorph PaymentPagedMetadata recordsRequested false */

/* polymorph PaymentPagedMetadata recordsReturned false */

/* polymorph PaymentPagedMetadata results false */
...
func (m *PaymentPagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PaymentPagedMetadata) UnmarshalBinary(b []byte) error {
	var res PaymentPagedMetadata

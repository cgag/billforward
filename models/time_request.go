...
/* polymorph TimeRequest advanceInclusively false */

/* polymorph TimeRequest created false */

/* polymorph TimeRequest dryRun false */

/* polymorph TimeRequest executionStrategy false */

/* polymorph TimeRequest freezeOnCompletion false */

/* polymorph TimeRequest handleAmendments false */

/* polymorph TimeRequest periods false */

/* polymorph TimeRequest skipIntermediatePeriods false */

/* polymorph TimeRequest to false */
...
func (m *TimeRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TimeRequest) UnmarshalBinary(b []byte) error {
	var res TimeRequest

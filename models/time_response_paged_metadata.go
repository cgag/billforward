...
/* polymorph TimeResponsePagedMetadata currentOffset false */

/* polymorph TimeResponsePagedMetadata currentPage false */

/* polymorph TimeResponsePagedMetadata executionTime false */

/* polymorph TimeResponsePagedMetadata nextPage false */

/* polymorph TimeResponsePagedMetadata recordsRequested false */

/* polymorph TimeResponsePagedMetadata recordsReturned false */

/* polymorph TimeResponsePagedMetadata results false */
...
func (m *TimeResponsePagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TimeResponsePagedMetadata) UnmarshalBinary(b []byte) error {
	var res TimeResponsePagedMetadata

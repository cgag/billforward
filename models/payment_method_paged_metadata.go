...
/* polymorph PaymentMethodPagedMetadata currentOffset false */

/* polymorph PaymentMethodPagedMetadata currentPage false */

/* polymorph PaymentMethodPagedMetadata executionTime false */

/* polymorph PaymentMethodPagedMetadata nextPage false */

/* polymorph PaymentMethodPagedMetadata recordsRequested false */

/* polymorph PaymentMethodPagedMetadata recordsReturned false */

/* polymorph PaymentMethodPagedMetadata results false */
...
func (m *PaymentMethodPagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PaymentMethodPagedMetadata) UnmarshalBinary(b []byte) error {
	var res PaymentMethodPagedMetadata

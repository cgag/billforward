...
type ProductRatePlan struct {
	...
	pricingComponentsField []PricingComponent
...
/* polymorph ProductRatePlan aggregatingComponents false */

/* polymorph ProductRatePlan changedBy false */

/* polymorph ProductRatePlan createZeroValuedInvoices false */

/* polymorph ProductRatePlan created false */

/* polymorph ProductRatePlan crmID false */

/* polymorph ProductRatePlan currency false */

/* polymorph ProductRatePlan duration false */

/* polymorph ProductRatePlan durationPeriod false */

/* polymorph ProductRatePlan failedPaymentBehaviour false */

/* polymorph ProductRatePlan fixedTermDefinitions false */

/* polymorph ProductRatePlan id false */

/* polymorph ProductRatePlan invoiceIssueType false */

/* polymorph ProductRatePlan issueDuration false */

/* polymorph ProductRatePlan issuePeriod false */

/* polymorph ProductRatePlan metadata false */

/* polymorph ProductRatePlan migrationBehaviour false */

/* polymorph ProductRatePlan name false */

/* polymorph ProductRatePlan paymentTerms false */

/* polymorph ProductRatePlan pricingComponents true */

func (m *ProductRatePlan) PricingComponents() []PricingComponent {
	return m.pricingComponentsField
}
func (m *ProductRatePlan) SetPricingComponents(val []PricingComponent) {
	m.pricingComponentsField = val
}

/* polymorph ProductRatePlan proRataMode false */

/* polymorph ProductRatePlan product false */

/* polymorph ProductRatePlan productID false */

/* polymorph ProductRatePlan productType false */

/* polymorph ProductRatePlan publicName false */

/* polymorph ProductRatePlan status false */

/* polymorph ProductRatePlan taxStatus false */

/* polymorph ProductRatePlan taxation false */

/* polymorph ProductRatePlan trial false */

/* polymorph ProductRatePlan trialPeriod false */

/* polymorph ProductRatePlan updated false */

/* polymorph ProductRatePlan validFrom false */

/* polymorph ProductRatePlan validTill false */
...
func (m *ProductRatePlan) UnmarshalJSON(raw []byte) error {
	...
	result.pricingComponentsField = pricingComponents
...
func (m ProductRatePlan) MarshalJSON() ([]byte, error) {
	...
	b2, err = json.Marshal(struct {
		...
		PricingComponents: m.pricingComponentsField,
	},
	)
	if err != nil {
		return nil, err
...
func (m *ProductRatePlan) validatePricingComponents(formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.PricingComponents()); i++ {
		...
		if err := m.pricingComponentsField[i].Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {

...
/* polymorph WebhookPagedMetadata currentOffset false */

/* polymorph WebhookPagedMetadata currentPage false */

/* polymorph WebhookPagedMetadata executionTime false */

/* polymorph WebhookPagedMetadata nextPage false */

/* polymorph WebhookPagedMetadata recordsRequested false */

/* polymorph WebhookPagedMetadata recordsReturned false */

/* polymorph WebhookPagedMetadata results false */
...
func (m *WebhookPagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *WebhookPagedMetadata) UnmarshalBinary(b []byte) error {
	var res WebhookPagedMetadata

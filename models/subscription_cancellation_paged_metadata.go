...
/* polymorph SubscriptionCancellationPagedMetadata currentOffset false */

/* polymorph SubscriptionCancellationPagedMetadata currentPage false */

/* polymorph SubscriptionCancellationPagedMetadata executionTime false */

/* polymorph SubscriptionCancellationPagedMetadata nextPage false */

/* polymorph SubscriptionCancellationPagedMetadata recordsRequested false */

/* polymorph SubscriptionCancellationPagedMetadata recordsReturned false */

/* polymorph SubscriptionCancellationPagedMetadata results false */
...
func (m *SubscriptionCancellationPagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *SubscriptionCancellationPagedMetadata) UnmarshalBinary(b []byte) error {
	var res SubscriptionCancellationPagedMetadata

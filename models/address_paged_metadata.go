...
/* polymorph AddressPagedMetadata currentOffset false */

/* polymorph AddressPagedMetadata currentPage false */

/* polymorph AddressPagedMetadata executionTime false */

/* polymorph AddressPagedMetadata nextPage false */

/* polymorph AddressPagedMetadata recordsRequested false */

/* polymorph AddressPagedMetadata recordsReturned false */

/* polymorph AddressPagedMetadata results false */
...
func (m *AddressPagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AddressPagedMetadata) UnmarshalBinary(b []byte) error {
	var res AddressPagedMetadata

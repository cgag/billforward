...
/* polymorph BillingEntityBase created false */
...
func (m *BillingEntityBase) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BillingEntityBase) UnmarshalBinary(b []byte) error {
	var res BillingEntityBase

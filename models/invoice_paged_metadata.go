...
/* polymorph InvoicePagedMetadata currentOffset false */

/* polymorph InvoicePagedMetadata currentPage false */

/* polymorph InvoicePagedMetadata executionTime false */

/* polymorph InvoicePagedMetadata nextPage false */

/* polymorph InvoicePagedMetadata recordsRequested false */

/* polymorph InvoicePagedMetadata recordsReturned false */

/* polymorph InvoicePagedMetadata results false */
...
func (m *InvoicePagedMetadata) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InvoicePagedMetadata) UnmarshalBinary(b []byte) error {
	var res InvoicePagedMetadata
